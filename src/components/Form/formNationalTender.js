        ...
        >
            {() => (
                <Form className="flex flex-col space-y-4">
                    <div className="flex flex-col md:flex-row items-center space-y-2 md:space-x-2 lg:space-x-5">
                        <div className="flex items-center sm:w-full mt-2">
                            <label htmlFor="publicacionDesde" className="font-semibold text-gray-800">
                                <Title>{"Publicación Desde:"}</Title>
                            </label>
                            <Field
                                type="date"
                                className="py-1 border rounded border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full sm:w-auto ml-1 mr-0.5"
                                id="publicacionDesde"
                            ...
                            <Field
                                type="date"
                                className="py-1 border rounded border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full sm:w-auto ml-0.5"
                                id="publicacionHasta"
                           ...
                           <div className="flex items-center sm:w-full">
                            <label htmlFor="presentacionDesde" className="font-semibold text-gray-800">
                                <Title className="lg:whitespace-nowrap">{"Presentación Desde:"}</Title>
                            </label>
                            <Field
                                type="date"
                                className="py-1 border rounded border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full sm:w-auto ml-1 mr-0.5"
                            ...
                            <Field
                                type="date"
                                className="py-1 border rounded border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full sm:w-auto ml-0.5 md:mt-0"
